...
$mail->SetFrom('fashionfiesta1998@gmail.com', 'Fashion Fiesta');

$mail->AddReplyTo("fashionfiesta1998@gmail.com","Fashion Fiesta");
...
if(!$mail->Send()) {
  echo "Mailer Error: " . $mail->ErrorInfo;
    ...
    $s="UPDATE `contacts` SET `status`='replied' WHERE `cid`=".$_REQUEST["hfid"];
    mysqli_query($con,$s);
echo $s;
